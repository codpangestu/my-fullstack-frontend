...
import { Play, Plus, ThumbsUp, Share2, Star, Calendar, Tag } from "lucide-react";
        ...
        <div className="relative z-10 max-w-[1440px] mx-auto px-6 md:px-12 lg:px-20 pt-20 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-4 group hidden lg:block">
            <div className="relative rounded-2xl overflow-hidden shadow-2xl shadow-black/60 border border-white/10 transform transition-all duration-500 group-hover:scale-[1.02]">
              <img src={movie.thumbnail} alt={movie.title} className="w-full object-cover aspect-[2/3]" />
          ...
          <div className="lg:col-span-8 text-white space-y-8">
            <div className="space-y-4">
              <div className="flex flex-wrap items-center gap-3">
                <span className="bg-blue-600 px-3 py-1 rounded text-[10px] font-black uppercase tracking-widest">Original</span>
                ...
                <span className="text-gray-400">|</span>
                <span className="border border-white/30 px-2 py-0.5 rounded text-xs font-bold text-gray-300">16+</span>
              </div>
            ...
            <div className="flex flex-wrap gap-4 items-center pt-4">
              ...
              <div className="flex gap-3">
                <button title="Add to List" className="bg-white/10 hover:bg-white/20 border border-white/10 p-4 rounded-md transition-all text-white">
                  <Plus size={24} />
                </button>
                <button title="Like" className="bg-white/10 hover:bg-white/20 border border-white/10 p-4 rounded-md transition-all text-white">
                  <ThumbsUp size={24} />
                </button>
                <button title="Share" className="bg-white/10 hover:bg-white/20 border border-white/10 p-4 rounded-md transition-all text-white">
                  <Share2 size={24} />
                </button>
              </div>
            </div>
        ...
        <div className="max-w-[1440px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            <div className="space-y-1">
              <span className="text-gray-500 text-xs font-bold uppercase tracking-widest">Genre</span>
              <p className="text-white text-lg font-bold">{movie.category?.name}</p>
            </div>
            <div className="space-y-1">
              <span className="text-gray-500 text-xs font-bold uppercase tracking-widest">Release Year</span>
              <p className="text-white text-lg font-bold">{movie.release_year}</p>
            </div>
            <div className="space-y-1">
              <span className="text-gray-500 text-xs font-bold uppercase tracking-widest">Rating</span>
            ...
            <div className="space-y-1">
              <span className="text-gray-500 text-xs font-bold uppercase tracking-widest">Studio</span>
              <p className="text-white text-lg font-bold italic">diStreaming Studio</p>
            </div>
          </div>
        </div>
      </section>
